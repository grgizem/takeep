    ...
    DatePicker.prototype = {
        ...
        detectNative : function(el) {
            ...
            if (navigator.userAgent
                    .match(/(iPad|iPhone); CPU(\ iPhone)? OS 5_\d/i)) {
        ...
        init : function() {
            ...
            .mousedown(function(e) {
                e.preventDefault()
            }).addClass('datepicker').append($nav, $calendar).insertAfter(
                    this.$el);

            this.$el.focus(this.show).click(this.show).change(
                    $.proxy(function() {
                        this.selectDate();
                    }, this));
        ...
        nav : function(c, months) {
            var $subnav = $(
                    '<div>' + '<span class="prev button">&larr;</span>'
            ...
            if (!this.curMonth
                ...
                for ( var ii = 0; ii <= num_days; ii++) {
                    var thisDay = new Date(rangeStart.getFullYear(), rangeStart
                            .getMonth(), rangeStart.getDate() + ii, 12, 00);
                ...
                $("[date='" + this.format(new Date()) + "']", this.$days)
                        .addClass('today');
        ...
        daysBetween : function(start, end) {
            ...
            var start = Date.UTC(start.getFullYear(), start.getMonth(), start
                    .getDate());
            var end = Date
                    .UTC(end.getFullYear(), end.getMonth(), end.getDate());
